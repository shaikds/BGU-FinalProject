...
import { Calendar, Clock, Users, Trophy, ChevronLeft, Loader2 } from "lucide-react"

import { generateGames, type Game } from "@/lib/games-data"
...
export default function GamesListPage() {
  ...
  const loadMoreGames = useCallback(async () => {
    ...
    const newGames = generateGames(5, pageRef.current * 5)
    pageRef.current += 1
    
    setGames((prev) => [...prev, ...newGames])
    
    // Stop after 30 games for demo
    if (pageRef.current >= 6) {
      setHasMore(false)
    }
